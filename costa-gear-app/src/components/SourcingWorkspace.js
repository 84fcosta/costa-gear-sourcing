  ...
  return <div>
    ...
    <div className="cg-subworkspace-header">
      <div className="cg-subworkspace-inner">
        <div><div className="cg-subworkspace-title">Sourcing</div><div className="cg-subworkspace-copy">Products, suppliers, quotes, RFQs and sourcing analysis in one workflow.</div></div>
